...
/**
 * Servlet implementation class transfertobankcontroller
 */
@WebServlet("/transfertobankcontroller")
public class transfertobankcontroller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public transfertobankcontroller() {
        super();
